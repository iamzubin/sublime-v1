...
contract SavingsAccount is ISavingsAccount, Initializable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function switchStrategy(
        ...
        require(IStrategyRegistry(strategyRegistry).registry(_currentStrategy), 'SavingsAccount::_currentStrategy do not exist');
        ...
        _sharesReceived = IYield(_newStrategy).lockTokens{value: _ethValue}(address(this), _token, _tokensReceived);

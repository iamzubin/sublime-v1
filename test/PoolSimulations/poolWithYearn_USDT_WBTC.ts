...
describe('Pool using Yearn Strategy with USDT (Borrow Token) and WBTC (Collateral Token)', async () => {
    let env: Environment;
    before(async () => {
        env = await createEnvironment(
            ...
            [] as CompoundPair[],
            [
                { asset: Contracts.USDT, liquidityToken: USDT_Yearn_Protocol_Address },

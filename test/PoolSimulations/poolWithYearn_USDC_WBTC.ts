...
describe('Pool using Yearn Strategy with USDC (Borrow Token) and WBTC (Collateral Token)', async () => {
    let env: Environment;
    before(async () => {
        env = await createEnvironment(
            ...
            [] as CompoundPair[],
            [
                { asset: Contracts.USDC, liquidityToken: USDC_Yearn_Protocol_Address },
